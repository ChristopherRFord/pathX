...
public class PathX
{
    ...
    public enum PathXPropertyType
    {
        ...
        IMAGE_GAME_SPEED_BAR,
        IMAGE_BUTTON_GAME_SPEED_CONTROLLER,
        IMAGE_BUTTON_GAME_SPEED_CONTROLLER_MOUSE_OVER,
        ...
        //POWER UPS
        IMAGE_BUTTON_MAKE_LIGHT_GREEN,
        IMAGE_BUTTON_MAKE_LIGHT_GREEN_MOUSE_OVER,
        IMAGE_BUTTON_MAKE_LIGHT_RED,
        IMAGE_BUTTON_MAKE_LIGHT_RED_MOUSE_OVER,
        IMAGE_BUTTON_DECREASE_SPEED_LIMIT,
        IMAGE_BUTTON_DECREASE_SPEED_LIMIT_MOUSE_OVER,
        IMAGE_BUTTON_INCREASE_SPEED_LIMIT,
        IMAGE_BUTTON_INCREASE_SPEED_LIMIT_MOUSE_OVER,
        
        IMAGE_BUTTON_INCREASE_PLAYER_SPEED,
        IMAGE_BUTTON_INCREASE_PLAYER_SPEED_MOUSE_OVER,
        IMAGE_BUTTON_FLAT_TIRE,
        IMAGE_BUTTON_FLAT_TIRE_MOUSE_OVER,
        IMAGE_BUTTON_EMPTY_GAS_TANK,
        IMAGE_BUTTON_EMPTY_GAS_TANK_MOUSE_OVER,
